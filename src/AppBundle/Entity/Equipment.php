...
class Equipment
{
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="time_to_verification", type="date")
     */
    ...
    /**
     * Many Equipments have One Place.
     * @ORM\ManyToOne(targetEntity="Place", inversedBy="equipments")
     * @ORM\JoinColumn(name="place_id",nullable=false,  referencedColumnName="id")
     */
    private $place;
     ...
     * @ORM\JoinColumn(name="etype_id", nullable=false, referencedColumnName="id")
     */
    private $etype;
     ...
     *
     * @param \DateTime $timeToVerification
     *
     * @return Equipment
     */
